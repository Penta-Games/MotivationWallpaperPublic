...
public class FragmentRandom extends Fragment {
    ...
    private void firstLoadData() {
        ...
        if (tools.isNetworkAvailable()) {
            ...
            dbHelper.deleteData(Constant.TABLE_RANDOM);
                ...
                public void onResponse(JSONArray response) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            dbHelper.saveWallpaper(arrayList.get(i), Constant.TABLE_RANDOM);
            ...
            showRefresh(false);
            arrayList = dbHelper.getRandom(Constant.TABLE_RANDOM);
            mAdapter = new AdapterWallpaper(getActivity(), arrayList);
            recyclerView.setAdapter(mAdapter);
        }
    ...
    private void loadMore() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Constant.URL_RANDOM_WALLPAPER + lastId, null, new Response.Listener<JSONArray>() {
            @Override
